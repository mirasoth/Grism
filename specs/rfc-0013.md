...
This RFC defines the **Semantic Reasoning & Neurosymbolic Layer** of HyperFrame.
...
* Persisted HyperFrames (RFC-0012)
...
A **semantic assertion** is a logical statement of the form:
...
Assertions are immutable once produced.
...
Ontologies are bound to HyperFrames via:
...
Rules are expressed as **Horn clauses**:

```
IF pattern AND constraints
THEN assertion
```
...
Inference results are persisted as derived HyperFrames.
...
Materialized facts MUST be marked as derived.
...
This RFC defines the **semantic conscience** of HyperFrame.

> **Data answers questions.
> Logic explains answers.
> Semantics explains why the answers matter.**
