...
**Status:** Draft
**Stage:** Core Engine
**Author(s):** Grism Core Team
**Created:** 2026-01-21
**Depends On:**

* RFC-0002 (Data Model & Hypergraph Representation)
* RFC-0003 (Expression & Type System)
...
Grism is designed as a **long-lived cognitive system**, not a transient database.
In such systems, **schemas evolve continuously**:
...
Traditional graph databases either:

* Enforce rigid schemas that block evolution, or
* Avoid schemas entirely, shifting complexity to application logic

Grism adopts a **third path**:

> **Schemas are explicit, typed, versioned, evolvable, and queryable — but never brittle.**

This RFC defines:

* The schema model for nodes, edges, hyperedges, and modalities
