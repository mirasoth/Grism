...
This RFC defines the **indexing, adjacency, and access path model** for HyperFrame.
...
3. **Adjacency Is Not a Join**
   Adjacency is a distinct semantic primitive.
...
## 10. Access Paths & Execution Modes

### 10.1 Relational Mode

* Value and composite indexes preferred
* Adjacency discouraged
...
* Adjacency REQUIRED for Expand
* Join-based access discouraged
* Label-based indexes preferred
...
* Planner must ensure consistency
...
This RFC formalizes **how HyperFrame touches data**.

> **Indexes accelerate predicates.
> Adjacency accelerates meaning.
