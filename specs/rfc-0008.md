...
This RFC defines the **physical plan representation** and **operator interfaces** for HyperFrame.
...
This RFC defines **what it means to execute a query** in HyperFrame.
