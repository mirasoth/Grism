...
This RFC defines the **runtime execution environment** for HyperFrame, including:
...
This RFC establishes the **minimum behavioral contract** for any HyperFrame execution runtime.
...
* **Execution Engine**
  Drives physical plan execution.

* **Scheduler**
  Decides when operators run.

* **Buffer Manager**
  Manages bounded in-flight data.

* **Backpressure Controller**
  Propagates demand signals.
...
## 13. Interaction with Execution Modes

### 13.1 Relational Mode
...
* Mixed pressure sources
* Mode transitions MUST not drop signals
...
This RFC defines the **heartbeat of HyperFrame execution**.

> **Operators define work.
> Plans define structure.
> The runtime decides whether the system survives reality.**
