...
This document defines the process, conventions, and guidelines for creating and managing RFCs (Requests for Comments) in the Grism project.
...
RFCs are the authoritative specifications for the Grism system. They define:
...
**For questions or clarifications about RFC management, contact the Grism core team.**
