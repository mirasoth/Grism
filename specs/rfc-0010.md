...
This RFC defines the **distributed and parallel execution model** for HyperFrame.
...
## 12. Execution Modes in Distributed Context

### 12.1 Relational Mode

* Data parallelism dominant
* Shuffle-heavy
* Scales well with uniform data

---

### 12.2 Graph Mode

* Adjacency locality critical
* Partitioning by node / hyperedge
* Cross-partition Expand is expensive

---

### 12.3 Hybrid Mode

* Mixed partitioning strategies
* Explicit mode transitions
* Planner-guided locality
...
RFC-0010 defines **how HyperFrame scales**.
...
This RFC defines **how HyperFrame executes at scale**—without sacrificing correctness.

> **Parallelism accelerates execution.
> Distribution amplifies mistakes.
> RFC-0010 ensures only speed is amplified.**
