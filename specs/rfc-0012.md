...
This RFC defines the **storage and persistence layer** for HyperFrame.

The storage layer is responsible for:

* Durable persistence of HyperFrames
...
### 4.1 HyperFrame Persistence

A persisted HyperFrame consists of:

* **Entity tables** (nodes, edges, hyperedges)
* **Property columns**
* **Role bindings**
* **Metadata**

Each persisted unit MUST have:
...
Storage is organized into immutable **segments**.
...
This RFC defines the **foundation of trust** for HyperFrame.

> **Logic defines truth.
> Execution defines speed.
> Storage defines memory.**
