...
This RFC specifies the **logical planning phase** of Hypergraph and defines the **rewrite rules** that may be applied to a logical plan.
...
1. **Semantic correctness**
   The plan corresponds to a valid Hypergraph algebra expression.
...
**Description**
Reorder independent `Expand` operators following architecture semantics (Section 8.2).
...
* Hyperedge materialization semantics are unchanged
...
Expand reordering MUST NOT change traversal semantics or hyperedge materialization.

---

---

### 6.4 Filter–Expand Fusion
...
* Predicate is deterministic
* Predicate does not require post-expansion context
...
* Formal equivalence proofs for Expand optimizations
